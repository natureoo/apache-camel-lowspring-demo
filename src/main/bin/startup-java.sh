...
SERVICE_NAME="`echo $workdir | grep -o -E "[^/]+$"`"
#SERVICE_NAME="apache-camel-java"
...
nohup java $JVM_OPTS $DEBUG_OPTS $USER_OPTS -cp $LIB_JARS demo.chenj.FailoverJavaCamel >> $logdir/$SERVICE_NAME-catalina.out 2>&1 &
